...
class Aplication():
    ...
    def tela_login(self):
        ...
        label_tt = ctk.CTkLabel(master=janela, text="Entre na sua conta", font=("Roboto", 18), text_color="#00B0F0").place(x=10, y=10)
        ...
        label = ctk.CTkLabel(master=login_frame, text="Sistema de login", font=('Roboto', 20, 'bold'), text_color='white').place(x=25, y=5)
